    ...
    render() {
        return (
            <div className="containerRanting">
                <div className="starContainer bgStar">
                    <div onClick={this.handleClick} id="1"
                         className={`rating star ${this.state.rate >= 1 ? 'active' : 'inactive'}`}/>
                </div>
                <div className="starContainer bgStar">
                    <div onClick={this.handleClick} id="2"
                         className={`rating ${this.state.rate >= 2 ? 'active' : 'inactive'}`}/>
                </div>
                <div className="starContainer bgStar">
                    <div onClick={this.handleClick} id="3"
                         className={`rating ${this.state.rate >= 3 ? 'active' : 'inactive'}`}/>
                </div>
                <div className="starContainer bgStar">
                    <div onClick={this.handleClick} id="4"
                         className={`rating ${this.state.rate >= 4 ? 'active' : 'inactive'}`}/>
                </div>
                <div className="starContainer bgStar">
                    <div onClick={this.handleClick} id="5"
                         className={`rating ${this.state.rate == 5 ? 'active' : 'inactive'}`}/>
                </div>
            </div>
        )
    }
